...
Assert-ReportCoverage 'docs/analysis/lines-4001-4500.md' 4001 4500
Assert-ReportCoverage 'docs/analysis/lines-4501-5000.md' 4501 5000
Assert-ReportCoverage 'docs/analysis/lines-5001-5500.md' 5001 5500
Assert-ReportCoverage 'docs/analysis/lines-5501-6000.md' 5501 6000
Assert-ReportCoverage 'docs/analysis/lines-6001-6500.md' 6001 6500
...
Write-Output "Verified: strict UTF-8 text, exact 8,401-line schedule, and complete batch-01/02/03/04/05/06/07/08/09/10/11/12/13/14/15 line coverage."
